...
- The main window now includes a `Subfolders` toggle for preview analysis, so you can analyze just the selected folder or include nested folders in the same plan.
