...
public static class PreviewProviderDefaults
{
    private static readonly Dictionary<string, PreviewProviderKind> DefaultMappings = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        [".docx"] = PreviewProviderKind.Office,
        [".docm"] = PreviewProviderKind.Office,
        [".dotx"] = PreviewProviderKind.Office,
        [".dotm"] = PreviewProviderKind.Office,
        [".pptx"] = PreviewProviderKind.Office,
        [".pptm"] = PreviewProviderKind.Office,
        [".ppsx"] = PreviewProviderKind.Office,
        [".ppsm"] = PreviewProviderKind.Office,
        [".potx"] = PreviewProviderKind.Office,
        [".potm"] = PreviewProviderKind.Office,
        [".xlsx"] = PreviewProviderKind.Office,
        [".xls"] = PreviewProviderKind.Office,
        [".xlsb"] = PreviewProviderKind.Office,
        [".xlsm"] = PreviewProviderKind.Office,
        [".xltx"] = PreviewProviderKind.Office,
        [".xltm"] = PreviewProviderKind.Office,
