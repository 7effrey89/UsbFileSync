...
internal interface IDropboxClient
{
    Task<DropboxApiClient.DropboxItem> GetEntryAsync(string relativePath, CancellationToken cancellationToken = default);

    Task<IReadOnlyList<DropboxApiClient.DropboxItem>> EnumerateAsync(string relativePath, CancellationToken cancellationToken = default);
